define(function(require, exports, module) {
    ...
    function compare(tmp, local) {
        ...
        for (var key in tmp) {
            if (key != "courseId" && key != "lessonId" && key != "createdTime" && tmp[key] != "" && tmp[key] != local[key]) {
                return true;
            }
        }
        return false;
    ...
    exports.run = function() {
        ...
        videoChooser.on('change', function(item) {
            ...
            var $title = $form.find('[id="live-title-field"]');
            if ($title.val() == "") {
        ...
        var validator = createValidator($form, [videoChooser]);
