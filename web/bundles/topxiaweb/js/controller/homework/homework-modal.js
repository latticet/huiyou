...
define(function(require, exports, module) {
    ...
    exports.run = function() {
        ...
        $form.on('submit', function(){
            ...
            //     Notify.danger('请先上传文件或添加作业网络链接！');
            //     return false;
            // }
             if ($form.find('[name="content"]').val().length === 0) {
                Notify.danger('作业描述不能为空');
                return false;
            }
            
            $.post($form.attr('action'), $form.serialize(), function(html){
                Notify.success('作业添加成功！');
