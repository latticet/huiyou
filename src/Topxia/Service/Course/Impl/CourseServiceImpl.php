...
class CourseServiceImpl extends BaseService implements CourseService
{
	...
	public function favoriteCourse($courseId)
	{
		...
		public function favoriteCourseByUserId($courseId,$userId)
	{
		...
		$favorite = $this->getFavoriteDao()->getFavoriteByUserIdAndCourseId($userId, $course['id']);
		if($favorite){
			throw $this->createServiceException("该收藏已经存在，请不要重复收藏!");
		}
		//添加动态
	...
	public function unFavoriteCourse($courseId)
	{
		...
		public function unFavoriteCourseByUserId($courseId,$userId)
	{
	...
	{
		return  $this->getLessonLearnDao()->findLearnsByLessonId($lessonId, $start, $limit);
	}
