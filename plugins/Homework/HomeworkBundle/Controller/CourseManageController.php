...
class CourseManageController extends \Topxia\WebBundle\Controller\BaseController
{
	...
	{      
        ...
        return $this->forward('HomeworkBundle:CourseManage:base',  array('id' => $id));
	}
	...
	public function baseAction(Request $request, $id)
	{
		...
		return $this->render('HomeworkBundle:CourseManage:base.html.twig', array(
			'course' => $course,
	...
	public function detailAction(Request $request, $id)
	{
		...
		return $this->render('HomeworkBundle:CourseManage:detail.html.twig', array(
			'course' => $course
		));
	}
	...
	public function pictureAction(Request $request, $id)
	{
		...
		return $this->render('HomeworkBundle:CourseManage:picture.html.twig', array(
			'course' => $course,
		));
	}
    ...
    public function pictureCropAction(Request $request, $id)
    {
        ...
        if($request->getMethod() == 'POST') {
            ...
            return $this->redirect($this->generateUrl('homework_manage_picture', array('id' => $course['id'])));
        }

        $fileId = $request->getSession()->get("fileId");
        list($pictureUrl, $naturalSize, $scaledSize) = $this->getFileService()->getImgFileMetaInfo($fileId, 480, 270);

        return $this->render('HomeworkBundle:CourseManage:picture-crop.html.twig', array(
            'course' => $course,
    ...
    public function priceAction(Request $request, $id)
    {
        ...
        return $this->render('HomeworkBundle:CourseManage:price.html.twig', array(
            'course' => $course,
    ...
    public function dataAction($id)
    {
        ...
        return $this->render('HomeworkBundle:CourseManage:learning-data.html.twig', array(
            'course' => $course,
    ...
    public function orderAction(Request $request, $id)
    {
        ...
        return $this->render('HomeworkBundle:CourseManage:course-order.html.twig', array(
            'course' =>$course,
            'request' =>$request,
            'orders' => $orders,
            'users' => $users,
    ...
    public function teachersAction(Request $request, $id)
    {
        ...
        return $this->render('HomeworkBundle:CourseManage:teachers.html.twig', array(
            'course' => $course,
            'teachers' => $teachers
        ));
    }
    ...
    public function courseSyncAction(Request $request,$id,$type)
    {
        ...
        return $this->render('HomeworkBundle:CourseManage:courseSync.html.twig',array(
        'course'=>$course,
        'type'=>$type,
        'title'=>$title,
        'url'=>$url,
    ...
    public function courseSyncEditAction(Request $request)
    {
        ...
        return $this->render('HomeworkBundle:CourseManage:courseSyncEdit.html.twig',array(
        'course'=>$course,
        'type'=>$type,
        'url'=>$url
        ));
